const PRODUCTS = [
  {
    ...
    {
          name: 'Pocketwise',
          domain: 'pocketwise.getfamilyfinance.com',
          href: 'https://pocketwise.getfamilyfinance.com',
          appHref: 'https://pocketwise.getfamilyfinance.com',
          description:
                  'Raise money-smart kids. Practical guides to pocket money, saving, and investing for parents of kids 8–15.',
          tags: ['Kids & money', 'Pocket money', 'Guides'],
          iconClass: 'product-icon-pocketwise',
          icon: (
                  <svg
              width="22"
        height="22"
      ...
      >
                  ...
                  <path d="M12 7v10M9.5 9.5c0-1 1.1-1.7 2.5-1.7s2.5.7 2.5 1.7c0 2.7-5 1.9-5 4.6 0 1 1.1 1.7 2.5 1.7s2.5-.7 2.5-1.7" />
          </svg>
    ),
      },
      ];
